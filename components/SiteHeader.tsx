      ...
      <div className={`mx-auto flex items-center justify-between px-6 sm:px-8 transition-all duration-300 ${
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-3">
            <Link href="/products" className={`hidden items-center gap-2 border bg-transparent font-semibold uppercase tracking-widest transition-all duration-300 lg:flex hover:scale-105 ${
              isSolid 
                ? "border-espresso/20 text-espresso px-3.5 py-1.5 text-[11px] hover:bg-espresso hover:text-white shadow-[3px_3px_0px_0px_#24130f] hover:shadow-[4px_4px_0px_0px_#c99a4a]" 
                : "border-crema/25 text-crema px-4 py-2 text-xs hover:bg-crema hover:text-espresso shadow-[3px_3px_0px_0px_rgba(247,239,225,0.25)] hover:shadow-[4px_4px_0px_0px_#c99a4a]"
            }`}>
              <ShoppingBag size={isSolid ? 14 : 16} />
              Shop
            </Link>
            <a href="#contact" className={`hidden items-center gap-2 bg-brass font-semibold uppercase tracking-widest transition-all duration-300 sm:flex hover:scale-105 shadow-[3px_3px_0px_0px_#24130f] ${
              isSolid 
                ? "text-espresso hover:bg-espresso hover:text-crema px-3.5 py-1.5 text-[11px] hover:shadow-[4px_4px_0px_0px_#c99a4a]" 
                : "text-espresso hover:bg-crema hover:text-espresso px-4 py-2 text-xs hover:shadow-[4px_4px_0px_0px_#f7efe1]"
            }`}>
        ...
        <div className="absolute left-0 right-0 top-[72px] w-full border border-espresso/10 bg-white/95 py-6 shadow-2xl md:hidden">
          <nav className="flex flex-col items-center gap-5 px-4">
            ...
            <div className="mt-3 flex w-full flex-col gap-3">
              <Link 
                href="/products" 
                className="flex items-center justify-center gap-2 border border-espresso/20 py-2.5 text-xs font-semibold uppercase tracking-widest text-espresso hover:bg-espresso hover:text-white transition shadow-[3px_3px_0px_0px_#24130f] hover:scale-105 hover:shadow-[4px_4px_0px_0px_#c99a4a]"
                onClick={() => setIsOpen(false)}
              >
              ...
              <a 
                href="#contact" 
                className="flex items-center justify-center gap-2 bg-brass py-2.5 text-xs font-semibold uppercase tracking-widest text-espresso hover:bg-espresso hover:text-crema transition shadow-[3px_3px_0px_0px_#24130f] hover:scale-105 hover:shadow-[4px_4px_0px_0px_#c99a4a]"
                onClick={() => setIsOpen(false)}
              >
