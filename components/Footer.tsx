    ...
    <footer className="bg-espresso text-crema">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-[1.2fr_0.8fr_0.8fr] lg:px-8">
        <div className="space-y-4">
          <Link href="/" className="inline-block">
            <Image src="/media/logo.jpg" alt="Mugamba Coffee Factory logo" width={48} height={48} className="rounded-full border border-white/10 object-cover" />
          </Link>
          <h2 className="font-serif text-xl sm:text-2xl tracking-tight">Mugamba Coffee Factory</h2>
          <p className="max-w-md text-xs sm:text-sm leading-relaxed text-crema/60">
        ...
        <div>
          ...
          <div className="mt-5 grid gap-3 text-xs sm:text-sm text-crema/80">
        ...
        <div>
          ...
          <div className="mt-5 grid gap-4 text-xs sm:text-sm text-crema/80">
            <span className="flex items-start gap-3">
              <MapPin size={18} className="shrink-0 text-brass mt-0.5" /> 
              <span>Kigali, Rwanda<br /><span className="text-xs opacity-60">KK 123 Street, Gikondo</span></span>
            </span>
            <a href="tel:+250787793722" className="flex items-center gap-3 hover:text-brass transition">
              <Phone size={18} className="shrink-0 text-brass" /> 
              <span>+250 787 793 722</span>
            </a>
            <a href="mailto:mugambaco@gmail.com" className="flex items-center gap-3 hover:text-brass transition">
              <Mail size={18} className="shrink-0 text-brass" /> 
              <span>mugambaco@gmail.com</span>
            </a>
            <a href="#contact" className="mt-1.5 inline-flex items-center justify-center gap-2 bg-brass px-4 py-2.5 text-xs sm:text-sm font-bold uppercase tracking-widest text-espresso transition hover:bg-crema">
      ...
      <div className="border-t border-white/10 py-6">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-xs tracking-wide text-crema/40">
