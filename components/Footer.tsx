      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 md:grid-cols-[1.2fr_0.8fr_0.8fr] lg:px-8">
        <div className="space-y-6">
          <Link href="/" className="inline-block">
            <Image src="/media/logo.jpg" alt="Mugamba Coffee Factory logo" width={64} height={64} className="border border-white/10" />
          </Link>
        ...
        <div>
          ...
          <div className="mt-8 grid gap-4 text-base text-crema/80">
            <Link href="/products" className="hover:text-brass transition underline-offset-4 hover:underline">Coffee Products</Link>
