...
export function Testimonials() {
  ...
  return (
    <div className="mt-16 grid gap-8 md:grid-cols-3">
      {items.map((item) => (
        <blockquote key={item.id} className="border-l-4 border-brass bg-espresso text-crema p-8 transition-all duration-300 shadow-[6px_6px_0px_0px_#24130f] hover:scale-[1.03] hover:shadow-[10px_10px_0px_0px_#c99a4a]">
